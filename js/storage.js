      ...
      chrome.bookmarks.getChildren("1", function(bookmarks){
        ...
        for (var i = 0; i < bookmarks.length; i++) {
          if (bookmarks[i].url != null && bookmarks[i].url.substring(0,4) == "http") {
            ...
            it3+='<div class="col-xs-2"><a href="'+bookmarks[i].url+'" id="'+bookmarks[i].title+'" class="thumbnail" title="'+bookmarks[i].title+'"><table><tr><td class="td"><object width="32" height="32" data="'+url.origin+'/favicon.ico'+'"><img width="35" height="35" src = "images/default.png"/></object></td><td class="td">'+bookmarks[i].title+'</td></tr></table></a></div>';
          }
        }
        it3+="</div>";
      ...
      chrome.management.getAll(function (apps_and_extensions){
        ...
        for (var i = 0, c = 0; i < apps_and_extensions.length; i++) {
          if(/app/.test(apps_and_extensions[i].type)){
            ...
            it2+='<div class="col-xs-2"><a href="" id= "app_'+apps_and_extensions[i].id+'" class="thumbnail" data="'+apps_and_extensions[i].id+'" title="'+apps_and_extensions[i].name+'"><img src="'+image_128_url+'"/></a></div>';
